...
from launch.conditions.evaluate_condition_expression_impl import (
    evaluate_condition_expression as expr_to_bool,
)
...
def generate_launch_description():
    ...
    config_abs_path = SharedFile(package_name, LaunchConfiguration("config"))
    world_abs_path = SharedFile(package_name, LaunchConfiguration("world"))
    urdf_model_abs_path = SharedFile(package_name, LaunchConfiguration("urdf_model"))
    rviz_config_abs_path = SharedFile(package_name, LaunchConfiguration("rviz_config"))
    ...
    gazebo_server_ld = IncludeLaunchDescription(
        launch_description_source=PythonLaunchDescriptionSource(
            launch_file_path=SharedFile("gazebo_ros", "launch", "gzserver.launch.py"),
        ),
        launch_arguments=[
    ...
    gazebo_client_ld = IncludeLaunchDescription(
        ...
        launch_description_source=PythonLaunchDescriptionSource(
            launch_file_path=SharedFile("gazebo_ros", "launch", "gzclient.launch.py"),
        ),
        launch_arguments=[
    ...
    joy_teleop_ld = IncludeLaunchDescription(
        ...
        launch_description_source=PythonLaunchDescriptionSource(
            launch_file_path=SharedFile("joy_teleop", "launch", "joy_teleop.launch.py"),
        ),
        launch_arguments=[
    ...
    def handle_exit(
        event: ProcessExited, context: LaunchContext
